...
CREATE TABLE IF NOT EXISTS snippets (id TEXT PRIMARY KEY NOT NULL, user_id TEXT, slug TEXT NOT NULL, language TEXT NOT NULL, title TEXT NOT NULL, visibility TEXT NOT NULL, stdin TEXT NOT NULL, run_command TEXT NOT NULL, suspected_spam INTEGER NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, FOREIGN KEY(user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE);
...
CREATE TABLE IF NOT EXISTS files (id TEXT PRIMARY KEY NOT NULL, snippet_id TEXT NOT NULL, user_id TEXT, name TEXT NOT NULL, content BLOB NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, FOREIGN KEY(snippet_id) REFERENCES snippets(id) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY(user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE);
