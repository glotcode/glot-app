...
pub fn get_dynamic_config() -> program_types.Program(
  ...
  program.perform(
    program_types.AppConfigEffect(
      app_config_algebra.GetDynamicConfig(next: program.from_mapped_result(
        _,
...
pub fn upsert_debug_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertDebugConfig(
      config: config,
...
pub fn upsert_availability_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertAvailabilityConfig(
      config: config,
      updated_at: updated_at,
      next: program.from_result,
    )),
...
pub fn upsert_auth_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertAuthConfig(
      config: config,
      updated_at: updated_at,
      next: program.from_result,
    )),
...
pub fn upsert_passkey_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertPasskeyConfig(
      config: config,
      updated_at: updated_at,
      next: program.from_result,
    )),
...
pub fn upsert_cleanup_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertCleanupConfig(
      config: config,
      updated_at: updated_at,
      next: program.from_result,
    )),
...
pub fn upsert_log_worker_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertLogWorkerConfig(
      config: config,
      updated_at: updated_at,
      next: program.from_result,
    )),
...
pub fn upsert_http_pool_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertHttpPoolConfig(
      config: config,
      updated_at: updated_at,
      next: program.from_result,
    )),
...
pub fn upsert_rate_limit_policy(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertRateLimitPolicy(
      action: action,
      policy: policy,
      updated_at: updated_at,
      next: program.from_result,
...
pub fn upsert_cloudflare_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertCloudflareConfig(
      config: config,
      updated_at: updated_at,
      next: program.from_result,
    )),
...
pub fn upsert_email_config(
  ...
  program.perform(
    program_types.AppConfigEffect(app_config_algebra.UpsertEmailConfig(
      config: config,
      updated_at: updated_at,
      next: program.from_result,
    )),
