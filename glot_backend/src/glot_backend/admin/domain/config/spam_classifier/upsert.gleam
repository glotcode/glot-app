...
pub fn upsert_spam_classifier_config(
  ...
  use user_action <- program.and_then(api_action_policy.enforce(
    ...
    action: api_action.admin(admin_action.UpsertAdminSpamClassifierConfigAction),
...
pub fn request_from_dynamic(
  data: Dynamic,
) -> Program(spam_classifier_config_dto.UpsertSpamClassifierConfigRequest) {
  program.decode_dynamic(data, spam_classifier_config_dto.decoder())
}
