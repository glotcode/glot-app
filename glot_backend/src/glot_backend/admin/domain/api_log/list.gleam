...
import glot_core/admin/api_log_dto.{
  type ListApiLogsRequest, type ListApiLogsResponse,
}
...
pub fn get_api_logs(
  ...
  request: ListApiLogsRequest,
) -> Program(ListApiLogsResponse) {
...
pub fn request_from_dynamic(data: Dynamic) -> Program(ListApiLogsRequest) {
